...
function renderSessionTable(sessions) {
  ...
  sessions.forEach(s => {
    ...
    } else if (s.source_kind === 'grok-build-usage') {
      sourceBadge = `<span class="badge source-badge" title="${escapeHtml(t('grok_source_usage_title'))}">${escapeHtml(t('grok_source_usage'))}</span>`;
    } else if (s.source_kind === 'grok-build-context') {
      sourceBadge = `<span class="badge source-badge" title="${escapeHtml(t('grok_source_context_title'))}">${escapeHtml(t('grok_source_context'))}</span>`;
    }
